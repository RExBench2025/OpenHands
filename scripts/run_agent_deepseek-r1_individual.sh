...
export LLM_MODEL="deepseek/deepseek-reasoner"
export LLM_API_KEY=$DEEPSEEK_KEY
export LLM_INPUT_TOKEN_COST="0.00000055"
export LLM_INPUT_TOKEN_COST_CACHED="0.000000014"
export LLM_OUTPUT_TOKEN_COST="0.00000219"
export AGENT_NAME="openhands_deepseek-r1"
...
git add .
git diff 'origin/main' > ${PATCHES_ROOT}/${TASK_NAME}/${level}/${AGENT_NAME}_${level}_run${RUN}.patch
git restore --staged .
git restore .
git clean -f
