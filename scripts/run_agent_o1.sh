...
export LLM_MODEL="openai/o1"
export LLM_API_KEY=$OPENAI_KEY
export LLM_INPUT_TOKEN_COST="0.000015"
export LLM_OUTPUT_TOKEN_COST="0.000060"
export AGENT_NAME="openhands_o1"
